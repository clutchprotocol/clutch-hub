...
const REPOS = [
  ...
  { name: 'Clutch Hub API', desc: 'Bridge between apps and the node. GraphQL and REST.', url: 'https://github.com/clutchprotocol/clutch-hub/tree/main/services/hub-api', icon: 'api' },
